...
# app.add_middleware(
#     CORSMiddleware,
#     allow_origins=["http://localhost:3000/criar-meme"],
#     allow_methods=["*"],
#     allow_headers=["*"],
# )
...
#     # IA gera legenda baseada na frase do usuário
...
#     # Abre a imagem e prepara para desenhar
...
#     # Divide o texto em linhas para não ultrapassar largura
...
#     # Calcula posição inferior do texto
